...
<div class="container-fluid requester-questTotalStat-node">
	...
	<p data-content="perform_areas.모바일"></p>
	
	<ul data-list="perform_areas">
		<li><span data-content="모바일"></span> : <span data-content="count"></span>번 수행.</li>
	</ul>
