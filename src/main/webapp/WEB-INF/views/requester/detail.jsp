...
<div class="container requester-detail"></div>
<hr>
<div><h3>발주한 전체 퀘스트 정보 관련 통계</h3></div>
<div class="container requester-questTotalStat-detail"></div>	
<hr>
...
function detail(id) {
	...
	ajax.get("/api/requester/"+id, {}, function(requester){
		...
		/* 준비중  */
		ajax.get("/api/quest/requester/state/wait", {}, function(list){
			$.addTemplateFormatter({
				date: function (value) { return $.datepicker.formatDate("yy년 mm월 dd일", new Date(value)); },
		...
		/* 진행중 */
		ajax.get("/api/quest/requester/stateGroup/ongoing", {}, function(list){
			$.addTemplateFormatter({
				date: function (value) { return $.datepicker.formatDate("yy년 mm월 dd일", new Date(value)); },
				link: function (value) { return "/quest/" + value; }
		    });
		...
		/* 완료중 */
		ajax.get("/api/quest/requester/state/complete", {}, function(list){
			$.addTemplateFormatter({
				date: function (value) { return $.datepicker.formatDate("yy년 mm월 dd일", new Date(value)); },
				link: function (value) { return "/quest/" + value; }
		    });
